...
5. Generate production-ready error handling code in the project's language showing:
...
Project notes:
- Prefer examples that fit the repository’s existing Stripe integration style (API versioning, webhooks, retries, idempotency).
